...
Plugin::Plugin(std::string name, std::string path)
{
	...
	this->state.Class<ProxyBlob>("Blob")
		...
		.method("SetPosition", &ProxyBlob::SetPosition)
	...
	this->state.Class<ProxyPlayer>("Player")
		...
		.method("GetVelX", &ProxyPlayer::GetVelX)
		.method("GetVelY", &ProxyPlayer::GetVelY)
		.method("GetMouseX", &ProxyPlayer::GetMouseX)
		.method("GetMouseY", &ProxyPlayer::GetMouseY)
		...
		.method("SetVelocity", &ProxyPlayer::SetVelocity)
		...
		.method("IsFrozen", &ProxyPlayer::IsFrozen)
