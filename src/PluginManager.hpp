...
Plugin::Plugin(std::string name, std::string path)
{
	...
	this->state.Class<ProxyPlayer>("Player")
		...
		.method("GetSpecialColor", &ProxyPlayer::SetSex)
		.method("SetSpecialColor", &ProxyPlayer::SetSex)
		.method("GetHead", &ProxyPlayer::SetSex)
		.method("ForceHead", &ProxyPlayer::SetSex)
